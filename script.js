document.addEventListener("DOMContentLoaded", function() {
    ...
    const commands = {
        ...
        "portfolio": () => {
            window.open("https://hs9181.vercel.app/", "_blank");
            return '';
        }, 
        "clear": () => { terminalBody.innerHTML = ''; return ''; },
        "echo": (args) => args.join(" "),
        "education": () => {
            return `<span style="color:${themeColors.textColor};">Dr. APJ Abdul Kalam Technical University</span> | 2021 - 2025`
        },
        "email": () => {
            window.open("mailto:hs918131@gmail.com");
            return 'You can reach me at: hs918131@gmail.com';
        },
        "exit": () => window.close(),
        "history": () => commandHistory.join("<br>"),
        "projects": "You can visit my portfolio website / github to see all my projects >"
        ,"pwd": "You are currently in the root directory.",
        "skills": () => {
            return `I am a fast learner and highly motivated individual. <hr> <span style="color:${themeColors.textColor};">Languages</span>: C++, Python, JavaScript, React.js, Next.js,  <br><span style="color:${themeColors.textColor};">Tools</span>: Docker, Kubernetes, Git, Framer, Webflow <br><span style="color:${themeColors.textColor};">Database Technologies</span>: MySQL, MongoDB <br><span style="color:${themeColors.textColor};">Strengths</span>: DSA, Frontend Development, UI/UX Design, Generative AI <br><span style="color:${themeColors.textColor};">Soft Skills</span>: Leadership, Team work, Communication, Time Management`},
        "socials": "Connect with me on <br>1. LinkedIn: https://www.linkedin.com/in/hs918131/,<br>2. GitHub: https://github.com/hs918131,<br>3. Twitter: https://x.com/hs918131",
        "welcome": "Hey There! I am Harshit Sharma, Full Stack Developer • UI/UX Designer <br> An aspiring computer science student with strong interest in full stack development and designing. <br> Loves Frontend and sits in front of laptop to see bugs 🐛 and issues in console laptop",
    ...
    function addNewPrompt() {
        ...
        newPrompt.innerHTML = `harshit@desktop:~$ <span contenteditable="true" class="user-input"></span>`;
